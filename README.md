...
![Project Screenshot](https://50projects50days.com/img/projects-img/44-custom-range-slider.png)

</div>

# Custom Range Slider

By using "Map range of numbers from another range of number" from stackoverflow built the custom range slider.
